...
const Testimonials = () => {
    return (
        <section className="mb-20 text-gray-700 md:mx-20 mx-8 mx">
            <div className="text-center md:max-w-xl lg:max-w-3xl mx-auto">
                <h3 className="text-3xl font-bold mb-6 text-gray-800">Testimonials</h3>
                <p className="mb-6 pb-2 md:mb-12 md:pb-0">
                    Have a glance to what my previous customers have to say.. 
                </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6 text-center">
                    ...
                    <div className="block rounded-lg shadow-lg bg-white">
                        ...
                        <div className="p-6">
                            ...
                            <p className="mt-4">
                                ...
                                Kamrul Saad is a great photographer. He has a great experience in his workfield.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="block rounded-lg shadow-lg bg-white">
                        ...
                        <div className="p-6">
                            ...
                            <p className="mt-4">
                                ...
                                I will definitely choose KAMRUL for my next family ceremony. He is very good at capturing moments.
                            </p>
                        </div>
                    </div>
                </div>
                <div>
                    <div className="block rounded-lg shadow-lg bg-white">
                        <div className="overflow-hidden rounded-t-lg h-28" style={{backgroundColor: "#6d5b98"}}></div>
                        <div className="w-24 -mt-12 overflow-hidden border-2 border-white rounded-full mx-auto bg-white">
                        ...
                        <div className="p-6">
                            ...
                            <p className="mt-4">
                                ...
                                KAMRUL SAAD covered my whole business trip's photography part. He is the best.
                            </p>
                        </div>
                    </div>
                </div>
